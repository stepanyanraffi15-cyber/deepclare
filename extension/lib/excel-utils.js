function goodsToExcelXlsx(declaration, goods) {
  ...
  const declRows = [
    ...
    ["Սահմանային մաքսակետ", decl.borderOffice ?? ""],
    ["Մեքենայի համարանիշ", decl.vehiclePlate ?? ""],
    ["Կցորդի համարանիշ", decl.hasTrailer ? (decl.trailerPlate ?? "") : ""],
    ["Մեքենաների քանակ", decl.transportQuantity ?? ""],
    ["Կոնտեյներ", decl.containerIndicator ?? ""],
    ["Ժամանման միջոցներ", decl.arrivalTransportMode ?? ""],
    ["Սահմանահատման միջոցներ", decl.borderTransportMode ?? ""],
